...
public class ParkingRecipt extends  Frame implements ActionListener
{
Frame frm;
JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12;
JTextField t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12;
JButton b1,b2,b3;
String a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a22;
...
public ParkingRecipt(String p4)
{	
...
public void setUpParkingRecipt()
{
...
l11.setBounds(400,140,150,25);
frm.add(l11);
t11.setBounds(500,140,150,25);
frm.add(t11);

l12.setBounds(400,170,150,25);
frm.add(l12);
t12.setBounds(500,170,150,25);
frm.add(t12);

b1.setBounds(300,500,100,25);
frm.add(b1);
b2.setBounds(425,500,100,25);
frm.add(b2);
b3.setBounds(550,500,100,25);
frm.add(b3);
  ...
  a1=t1.getText();
	try
	{
		...
		{   
		  ...
		  t7.setText(rst.getString(11));
		  t8.setText(rst.getString(12));
		  t9.setText(rst.getString(13));
		  t10.setText(rst.getString(14));
		  t11.setText(rst.getString(9));
		  t12.setText(rst.getString(10));
